...
class JobOrder(models.Model):
    ...
    def action_complete_work_order(self):
        ...
        # for data in self.material_order_ids:
        #     for m in data.job_order_id.job_sheet_id.cost_material_ids:
        #         if data.material_id.id == m.material_id.id and data.sub_category_id.id == m.sub_category_id.id:
        #             remain_qty = m.remain_qty
        #             m.remain_qty = remain_qty - data.qty
        self.state = 'complete'
